...
public class UserService {
    ...
    public User 카카오로그인(String code) {
        ...
        body.add("client_id", "43ff53cecb37af349eacf128349d152f");
    ...
    public User 네이버로그인(String code, String state) {
        // 1. code로 네이버에서 토큰 받기 (위임완료) - oauth2.0
        ...
        MultiValueMap<String, String> body = new LinkedMultiValueMap<>();
        body.add("grant_type", "authorization_code");
        body.add("client_id", "QxYas2SZGRkzYfZuqlHl");
        body.add("client_secret", "irNzz3Slb5");
